...
export const RoomReadingsStepNew: React.FC<RoomReadingsStepNewProps> = ({ job, onNext, visitNumber }) => {
  ...
  const handleAddReading = () => {
    if (!selectedMaterial || !newReading) {
      toast.error('Please enter a moisture reading');
      return;
    }
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-800 list-disc ml-5 space-y-1">
              <li>Return to <strong>exact same locations</strong> for consistent measurement</li>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <ul className="text-xs text-gray-600 list-disc ml-5 space-y-1">
          <li>Take readings at the same locations and times each day for accurate trend analysis</li>
          <li>Materials are dry when within 2% of dry standard OR below 12%</li>
        </ul>
      </div>
    </div>
  );
