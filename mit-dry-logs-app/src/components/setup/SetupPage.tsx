        ...
        psmData: {
          adjusterCommunications: [
            {
              ...
              timestamp: Timestamp.fromDate(new Date('2025-01-16')),
              contactedBy: 'Demo PSM',
              summary: 'Initial call to discuss scope. Adjuster requested photos and moisture readings.',
              questionsAsked: ['When will equipment be pulled?', 'Any structural damage?'],
              answersProvided: ['Estimated 3-4 days', 'No structural damage observed'],
              nextStep: 'Send photos and initial moisture readings',
              followUpDate: Timestamp.fromDate(new Date('2025-01-18')),
            },
          ],
          approvalStatus: {
            demoScope: 'pending',
          ...
          documentationReview: {
            checklist: {
              ...
              demoDocumented: false,
              customerSignatures: false,
              matterportCompleted: false,
            },
            missingItems: ['Final Photos', 'Moisture Log'],
            reviewedBy: 'Demo PSM',
          ...
          redFlags: [
            {
              ...
              type: 'missing-photos',
              severity: 'medium',
              description: 'Missing arrival and assessment photos for John Smith job',
          ...
          psmPhase: {
            ...
            assignedPSM: 'Demo PSM',
            startedReviewAt: Timestamp.now(),
            daysInPhase: 2,
      ...
      },
      {
        ...
        psmData: {
          ...
          approvalStatus: {
            ...
            conditionalApprovals: [
              {
                item: 'Air Scrubber Rental',
                condition: 'Pending CAT 2 water classification confirmation',
                conditionMet: false,
              },
            ],
          },
          homeownerCommunications: [
            {
              id: 'home-1',
              timestamp: Timestamp.fromDate(new Date('2025-01-19')),
              contactedBy: 'Demo PSM',
              method: 'phone',
              topicsDiscussed: ['Timeline explanation', 'Equipment plan review'],
              questionsAsked: ['When will work start?', 'How long will it take?'],
            },
          ],
          documentationReview: {
            checklist: {
            ...
            missingItems: ['Arrival Photos', 'Assessment Photos', 'Moisture Readings', 'Equipment Log'],
            reviewedBy: 'Demo PSM',
            reviewedAt: Timestamp.now(),
            readyForSubmission: false,
          },
          ...
          redFlags: [
            {
              ...
              type: 'missing-photos',
              severity: 'high',
              description: 'Multiple required photos missing - arrival, assessment',
              detectedAt: Timestamp.now(),
              resolved: false,
            },
            {
              ...
              severity: 'medium',
              description: 'No equipment deployed yet for pre-install job',
              detectedAt: Timestamp.now(),
              resolved: false,
            },
          ],
          psmPhase: {
            ...
            assignedPSM: 'Demo PSM',
            daysInPhase: 1,
            notes: 'Pre-install review - awaiting field work completion',
          },
        },
      },
      {
        ...
        psmData: {
          adjusterCommunications: [
            {
              ...
              timestamp: Timestamp.fromDate(new Date('2025-01-12')),
              contactedBy: 'Demo PSM',
              summary: 'Sent demo scope with photos. Adjuster requested additional containment details.',
              questionsAsked: ['What containment protocol for CAT 3?', 'Timeline for completion?'],
              answersProvided: ['Full containment per IICRC S500', 'Estimated 7-10 days total'],
              nextStep: 'Awaiting demo approval',
              followUpDate: Timestamp.fromDate(new Date('2025-01-15')),
            },
            {
              id: 'comm-4',
              communicationType: 'call',
              timestamp: Timestamp.fromDate(new Date('2025-01-17')),
              contactedBy: 'Demo PSM',
              summary: 'Follow-up call. Adjuster approved demo scope with conditions.',
              questionsAsked: [],
              answersProvided: [],
              nextStep: 'Proceed with demo',
            },
          ],
          approvalStatus: {
            demoScope: 'approved',
            demoAmount: {
              ...
              approved: 7200,
              deniedAmount: 1300,
              denialReason: 'Baseboards excluded - considered cosmetic',
            },
            equipmentPlan: 'approved',
            billableItems: {
              'air-scrubbers': {
          ...
          homeownerCommunications: [
            {
              id: 'home-2',
              timestamp: Timestamp.fromDate(new Date('2025-01-11')),
              contactedBy: 'Demo PSM',
              method: 'phone',
              topicsDiscussed: ['CAT 3 water concerns', 'Safety protocols', 'Timeline questions'],
              questionsAsked: ['How long until complete?', 'Is it safe to work in building?'],
            },
            {
              id: 'home-3',
              timestamp: Timestamp.fromDate(new Date('2025-01-18')),
              contactedBy: 'Demo PSM',
              method: 'in-person',
              topicsDiscussed: ['Demo progress review', 'Containment verification'],
              questionsAsked: [],
            },
          ],
          documentationReview: {
            checklist: {
              allRoomsPhotographed: true,
              moistureReadingsComplete: true,
              equipmentScanned: true,
              demoDocumented: true,
            ...
            missingItems: ['Final Demo Photos'],
            reviewedBy: 'Demo PSM',
            reviewedAt: Timestamp.now(),
          ...
          redFlags: [
            {
              ...
              type: 'cost-overrun',
              severity: 'high',
              description: 'Demo costs approaching estimate. Monitor additional work closely.',
              detectedAt: Timestamp.fromDate(new Date('2025-01-17')),
              resolved: false,
            },
            {
              id: 'flag-5',
              type: 'timeline-delay',
              severity: 'medium',
              description: 'Job running 2 days behind estimated schedule',
              detectedAt: Timestamp.now(),
              resolved: false,
            },
          ],
          psmPhase: {
            ...
            assignedPSM: 'Demo PSM',
            startedReviewAt: Timestamp.fromDate(new Date('2025-01-15')),
            submittedToAdjusterAt: Timestamp.fromDate(new Date('2025-01-17')),
            daysInPhase: 5,
            notes: 'Submitted to adjuster on 1/17. Awaiting final approval for invoice generation.',
          },
        },
      },
    ];
